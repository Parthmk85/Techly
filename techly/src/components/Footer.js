    ...
    <footer className="bg-linear-to-br from-gray-900 to-blue-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start">
                ...
                <span>2067B, street no 8, Akshardham-2, Bhavnagar - 364002 </span>
              </li>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center text-gray-300">
          <p>&copy; {currentYear} Techly. All rights reserved. Built with ❤️ by Techly Team</p>
        </div>
      </div>
    </footer>
  );
